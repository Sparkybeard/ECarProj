...
public class ParkEndpointManager {
	...
	/** Port implementation */
	private ParkPortImpl portImpl = new ParkPortImpl(this);

	/** Obtain Port implementation */
	public ParkPortType getPort() {
		return portImpl;
	}
	...
	public ParkEndpointManager(String uddiURL, String wsName, String wsURL) {
	...
	public ParkEndpointManager(String wsURL) {
		if (wsURL == null)
